...
public class EventRecord extends UpdatableRecordImpl<EventRecord> implements Record11<Long, Integer, LocalDateTime, Integer, LocalDateTime, String, LocalDateTime, EventStatus, String, LocalDateTime, Long> {
    ...
    @Override
    public Row11<Long, Integer, LocalDateTime, Integer, LocalDateTime, String, LocalDateTime, EventStatus, String, LocalDateTime, Long> valuesRow() {
    ...
    @Override
    public EventRecord values(Long value1, Integer value2, LocalDateTime value3, Integer value4, LocalDateTime value5, String value6, LocalDateTime value7, EventStatus value8, String value9, LocalDateTime value10, Long value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventRecord(Long id, Integer capacity, LocalDateTime createdAt, Integer currentNumberOfPeople, LocalDateTime eventEndDatetime, String eventName, LocalDateTime eventStartDatetime, EventStatus eventStatus, String memo, LocalDateTime modifiedAt, Long placeId) {
        super(Event.EVENT);
