...
class APIExceptionHandlerTest {
    ...
    private APIExceptionHandler suf;
    private WebRequest webRequest;

    @BeforeEach
    void setUp() {
        suf = new APIExceptionHandler();
    ...
    void givenValidationException_whenCallingValidation_thenReturnsResponseEntity() {
        ...
        // When
        ResponseEntity<Object> response = suf.validation(e, webRequest);
    ...
    void givenGeneralException_whenCallingValidation_thenReturnsResponseEntity() {
        ...
        // When
        ResponseEntity<Object> response = suf.general(e, webRequest);
    ...
    @DisplayName("프로젝트 기타 오류 - 응답 데이터 정의")
    @Test
    void givenOtherException_whenCallingValidation_thenReturnsResponseEntity() {
        ...
        // When
        ResponseEntity<Object> response = suf.exception(e, webRequest);
